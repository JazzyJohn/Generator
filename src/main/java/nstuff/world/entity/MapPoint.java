...
import static nstuff.world.Generator.GENERATE_PHASE;
...
public class MapPoint {
    ...
    private PointHumidityType humidityType= PointHumidityType.VERY_HIGH;
    ...
    public boolean isFreshWater() {
        return landType == PointLandType.RIVER||landType==PointLandType.LAKE;
    }
